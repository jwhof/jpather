...
var app = (function () {
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "id", "start-pos-x");
    			attr_dev(input, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "0.01");
    			add_location(input, file, 805, 8, 17982);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(805:8) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "id", "start-pos-y");
    			attr_dev(input, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "0.01");
    			add_location(input, file, 812, 8, 18386);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(812:8) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    // (833:5) {#each path.controlPoints as { x, y }}
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "class", "point svelte-w5p6go");
    			set_style(div0, "left", /*x*/ ctx[12] / 144 * 100 + "%");
    			set_style(div0, "bottom", /*y*/ ctx[13] / 144 * 100 + "%");
    			set_style(div0, "background", /*path*/ ctx[14].color);
    			add_location(div0, file, 834, 6, 19300);
    			attr_dev(div1, "class", "hover-point svelte-w5p6go");
    			add_location(div1, file, 833, 5, 19268);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(833:5) {#each path.controlPoints as { x, y }}",
    		ctx
    	});
    ...
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(832:4) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-w5p6go");
    			add_location(img, file, 841, 5, 19486);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(841:4) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(polyline, "class", "curve svelte-w5p6go");
    			...
    			add_location(polyline, file, 847, 7, 19851);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(847:6) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label, "class", "svelte-w5p6go");
    			add_location(label, file, 883, 11, 23426);
    		},
    		m: function mount(target, anchor) {
    ...
    // (881:10) {#if (path.controlPoints.length >= 2) && (i > 0) && (i < 2)}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(label, "user-select", "none");
    			attr_dev(label, "class", "svelte-w5p6go");
    			add_location(label, file, 881, 11, 23301);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    			append_dev(label, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(881:10) {#if (path.controlPoints.length >= 2) && (i > 0) && (i < 2)}",
    		ctx
    	});
    ...
    // (886:10) {#if i > 0 || path.controlPoints.length === 1}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label0, "class", "cp-x svelte-w5p6go");
    			attr_dev(label0, "for", label0_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[66]);
    			set_style(label0, "user-select", "none");
    			add_location(label0, file, 888, 13, 23707);
    			attr_dev(input0, "id", input0_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[66]);
    			attr_dev(input0, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 889, 13, 23811);
    			attr_dev(div0, "class", "control-point-mini-box-x svelte-w5p6go");
    			add_location(div0, file, 887, 12, 23655);
    			attr_dev(label1, "class", "cp-y svelte-w5p6go");
    			attr_dev(label1, "for", label1_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[66] + "-y");
    			set_style(label1, "user-select", "none");
    			add_location(label1, file, 892, 13, 24073);
    			attr_dev(input1, "id", input1_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[66] + "-y");
    			attr_dev(input1, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 893, 13, 24179);
    			attr_dev(div1, "class", "control-point-mini-box-y svelte-w5p6go");
    			add_location(div1, file, 891, 12, 24021);
    			attr_dev(div2, "class", "control-point-mini-box svelte-w5p6go");
    			add_location(div2, file, 886, 11, 23606);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(886:10) {#if i > 0 || path.controlPoints.length === 1}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-w5p6go");
    			add_location(path_1, file, 898, 285, 24759);
    			...
    			attr_dev(svg, "class", "svelte-w5p6go");
    			add_location(svg, file, 898, 11, 24485);
    		},
    		m: function mount(target, anchor) {
    ...
    // (879:8) {#each path.controlPoints as { x, y }
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "control-point-box svelte-w5p6go");
    			add_location(div, file, 879, 9, 23187);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(879:8) {#each path.controlPoints as { x, y }",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "svelte-w5p6go");
    			add_location(path0, file, 864, 534, 20848);
    			...
    			attr_dev(svg0, "class", "svelte-w5p6go");
    			add_location(svg0, file, 864, 8, 20322);
    			attr_dev(path1, "d", "M440-240v-368L296-464l-56-56 240-240 240 240-56 56-144-144v368h-80Z");
    			attr_dev(path1, "class", "svelte-w5p6go");
    			add_location(path1, file, 866, 482, 21479);
    			...
    			attr_dev(svg1, "class", "svelte-w5p6go");
    			add_location(svg1, file, 866, 8, 21005);
    			attr_dev(input, "type", "color");
    			attr_dev(input, "class", "color-circle svelte-w5p6go");
    			set_style(input, "background-color", /*path*/ ctx[14].color);
    			add_location(input, file, 867, 8, 21573);
    			attr_dev(p, "class", "path-title svelte-w5p6go");
    			set_style(p, "user-select", "none");
    			add_location(p, file, 868, 8, 21743);
    			attr_dev(div0, "class", "path-and-color svelte-w5p6go");
    			add_location(div0, file, 862, 7, 20220);
    			...
    			attr_dev(path2, "class", "svelte-w5p6go");
    			add_location(path2, file, 872, 276, 22205);
    			...
    			attr_dev(svg2, "class", "svelte-w5p6go");
    			add_location(svg2, file, 872, 8, 21937);
    			...
    			attr_dev(path3, "class", "svelte-w5p6go");
    			add_location(path3, file, 873, 273, 22691);
    			...
    			attr_dev(svg3, "class", "svelte-w5p6go");
    			add_location(svg3, file, 873, 8, 22426);
    			attr_dev(div1, "class", "add-and-remove svelte-w5p6go");
    			add_location(div1, file, 870, 7, 21835);
    			attr_dev(div2, "class", "path-header svelte-w5p6go");
    			add_location(div2, file, 861, 6, 20187);
    			attr_dev(div3, "class", "path-control-points svelte-w5p6go");
    			add_location(div3, file, 877, 7, 23094);
    			attr_dev(div4, "class", "path svelte-w5p6go");
    			set_style(div4, "border-color", /*path*/ ctx[14].color);
    			add_location(div4, file, 860, 5, 20126);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(860:4) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-w5p6go");
    			add_location(path_1, file, 919, 134, 25772);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "height", "24px");
    			attr_dev(svg, "viewBox", "0 -960 960 960");
    			attr_dev(svg, "width", "24px");
    			attr_dev(svg, "fill", "#FF474D");
    			attr_dev(svg, "class", "svelte-w5p6go");
    			add_location(svg, file, 919, 6, 25644);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path_1);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-w5p6go");
    			add_location(path_1, file, 917, 134, 25541);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "height", "24px");
    			attr_dev(svg, "viewBox", "0 -960 960 960");
    			attr_dev(svg, "width", "24px");
    			...
    			attr_dev(svg, "class", "svelte-w5p6go");
    			add_location(svg, file, 917, 7, 25414);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path_1);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "page-title svelte-w5p6go");
    			add_location(h1, file, 759, 2, 16185);
    			set_style(button0, "user-select", "none");
    			attr_dev(button0, "class", "svelte-w5p6go");
    			add_location(button0, file, 761, 3, 16254);
    			set_style(button1, "user-select", "none");
    			attr_dev(button1, "class", "svelte-w5p6go");
    			add_location(button1, file, 762, 3, 16353);
    			attr_dev(div0, "class", "export-import svelte-w5p6go");
    			add_location(div0, file, 760, 2, 16223);
    			attr_dev(div1, "class", "header svelte-w5p6go");
    			add_location(div1, file, 758, 1, 16162);
    			attr_dev(h20, "class", "section-title svelte-w5p6go");
    			set_style(h20, "user-select", "none");
    			add_location(h20, file, 772, 6, 16610);
    			attr_dev(label0, "for", "robotUnits");
    			set_style(label0, "user-select", "none");
    			attr_dev(label0, "class", "svelte-w5p6go");
    			add_location(label0, file, 775, 7, 16723);
    			option0.__value = "inches";
    			option0.value = option0.__value;
    			attr_dev(option0, "class", "svelte-w5p6go");
    			add_location(option0, file, 777, 8, 16879);
    			option1.__value = "cm";
    			option1.value = option1.__value;
    			attr_dev(option1, "class", "svelte-w5p6go");
    			add_location(option1, file, 778, 8, 16926);
    			attr_dev(select, "id", "robotUnits");
    			attr_dev(select, "class", "standard-input-box svelte-w5p6go");
    			if (/*robotUnits*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[28].call(select));
    			add_location(select, file, 776, 7, 16795);
    			attr_dev(div2, "class", "robot-options svelte-w5p6go");
    			add_location(div2, file, 774, 6, 16688);
    			attr_dev(label1, "for", "robot-length");
    			set_style(label1, "user-select", "none");
    			attr_dev(label1, "class", "svelte-w5p6go");
    			add_location(label1, file, 783, 7, 17038);
    			attr_dev(input0, "id", "robot-length");
    			attr_dev(input0, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 784, 7, 17119);
    			attr_dev(div3, "class", "robot-options svelte-w5p6go");
    			add_location(div3, file, 782, 6, 17003);
    			attr_dev(label2, "for", "robot-width");
    			set_style(label2, "user-select", "none");
    			attr_dev(label2, "class", "svelte-w5p6go");
    			add_location(label2, file, 788, 7, 17282);
    			attr_dev(input1, "id", "robot-width");
    			attr_dev(input1, "class", "standard-input-box svelte-w5p6go");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 789, 7, 17361);
    			attr_dev(div4, "class", "robot-options svelte-w5p6go");
    			add_location(div4, file, 787, 6, 17247);
    			attr_dev(h21, "id", "field-options");
    			attr_dev(h21, "class", "section-title svelte-w5p6go");
    			set_style(h21, "user-select", "none");
    			add_location(h21, file, 794, 6, 17495);
    			set_style(label3, "user-select", "none");
    			attr_dev(label3, "class", "svelte-w5p6go");
    			add_location(label3, file, 797, 6, 17655);
    			attr_dev(label4, "class", "cp-x svelte-w5p6go");
    			set_style(label4, "user-select", "none");
    			add_location(label4, file, 803, 8, 17885);
    			attr_dev(div5, "class", "control-point-mini-box-x svelte-w5p6go");
    			add_location(div5, file, 801, 7, 17773);
    			attr_dev(label5, "class", "cp-x svelte-w5p6go");
    			set_style(label5, "user-select", "none");
    			add_location(label5, file, 810, 8, 18289);
    			attr_dev(div6, "class", "control-point-mini-box-y svelte-w5p6go");
    			add_location(div6, file, 808, 7, 18177);
    			attr_dev(div7, "class", "control-point-mini-box svelte-w5p6go");
    			add_location(div7, file, 800, 6, 17729);
    			attr_dev(h22, "id", "advanced-options");
    			attr_dev(h22, "class", "section-title svelte-w5p6go");
    			set_style(h22, "user-select", "none");
    			add_location(h22, file, 817, 6, 18595);
    			attr_dev(label6, "for", "field-length");
    			set_style(label6, "user-select", "none");
    			attr_dev(label6, "class", "svelte-w5p6go");
    			add_location(label6, file, 819, 7, 18735);
    			attr_dev(input2, "id", "auto-link-paths");
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "class", "svelte-w5p6go");
    			add_location(input2, file, 820, 7, 18826);
    			attr_dev(div8, "class", "advanced-options svelte-w5p6go");
    			add_location(div8, file, 818, 6, 18697);
    			attr_dev(label7, "for", "field-length");
    			set_style(label7, "user-select", "none");
    			attr_dev(label7, "class", "svelte-w5p6go");
    			add_location(label7, file, 823, 7, 18962);
    			attr_dev(input3, "id", "auto-link-paths");
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "class", "svelte-w5p6go");
    			add_location(input3, file, 824, 7, 19046);
    			attr_dev(div9, "class", "advanced-options svelte-w5p6go");
    			add_location(div9, file, 822, 6, 18924);
    			attr_dev(div10, "class", "svelte-w5p6go");
    			add_location(div10, file, 771, 5, 16598);
    			attr_dev(div11, "class", "robot-options-menu svelte-w5p6go");
    			add_location(div11, file, 770, 4, 16560);
    			attr_dev(div12, "class", "settings-column svelte-w5p6go");
    			add_location(div12, file, 769, 3, 16526);
    			...
    			attr_dev(svg, "class", "svelte-w5p6go");
    			add_location(svg, file, 845, 5, 19715);
    			attr_dev(div13, "class", "field svelte-w5p6go");
    			add_location(div13, file, 830, 3, 19172);
    			set_style(button2, "user-select", "none");
    			attr_dev(button2, "class", "svelte-w5p6go");
    			add_location(button2, file, 908, 4, 25097);
    			attr_dev(div14, "class", "paths svelte-w5p6go");
    			add_location(div14, file, 858, 3, 20074);
    			attr_dev(div15, "class", "container svelte-w5p6go");
    			add_location(div15, file, 768, 2, 16499);
    			attr_dev(div16, "class", "play-button svelte-w5p6go");
    			add_location(div16, file, 914, 4, 25297);
    			attr_dev(input4, "type", "range");
    			attr_dev(input4, "id", "scrub");
    			attr_dev(input4, "min", "0");
    			attr_dev(input4, "max", "100");
    			attr_dev(input4, "step", "0.001");
    			attr_dev(input4, "class", "svelte-w5p6go");
    			add_location(input4, file, 923, 4, 25952);
    			attr_dev(div17, "class", "scrubbing-bar svelte-w5p6go");
    			add_location(div17, file, 913, 3, 25265);
    			attr_dev(div18, "class", "footer svelte-w5p6go");
    			add_location(div18, file, 912, 2, 25241);
    			attr_dev(div19, "class", "main-content svelte-w5p6go");
    			add_location(div19, file, 766, 1, 16468);
    			attr_dev(div20, "class", "svelte-w5p6go");
    			add_location(div20, file, 757, 0, 16155);
    		},
