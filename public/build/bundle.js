...
var app = (function () {
    ...
    function create_if_block_11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "class", "start-pos-box svelte-xlwemc");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "0.01");
    			add_location(input, file, 879, 8, 20526);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(879:8) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    function create_if_block_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "0.01");
    			add_location(input, file, 886, 8, 20908);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(886:8) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    // (907:5) {#each path.controlPoints as { x, y }}
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "class", "point svelte-xlwemc");
    			set_style(div0, "left", /*x*/ ctx[12] / 144 * 100 + "%");
    			set_style(div0, "bottom", /*y*/ ctx[13] / 144 * 100 + "%");
    			set_style(div0, "background", /*path*/ ctx[14].color);
    			add_location(div0, file, 908, 6, 21800);
    			attr_dev(div1, "class", "hover-point svelte-xlwemc");
    			add_location(div1, file, 907, 5, 21768);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(907:5) {#each path.controlPoints as { x, y }}",
    		ctx
    	});
    ...
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(906:4) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_if_block_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-xlwemc");
    			add_location(img, file, 915, 5, 21986);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(915:4) {#if $paths.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(polyline, "class", "curve svelte-xlwemc");
    			...
    			add_location(polyline, file, 921, 7, 22352);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(921:6) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(/*i*/ ctx[80]);
    			t2 = text(":");
    			attr_dev(label, "for", label_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80]);
    			set_style(label, "user-select", "none");
    			attr_dev(label, "class", "svelte-xlwemc");
    			add_location(label, file, 961, 11, 26255);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*$paths*/ 32 && label_for_value !== (label_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80])) {
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(label, "user-select", "none");
    			attr_dev(label, "class", "svelte-xlwemc");
    			add_location(label, file, 959, 11, 26096);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    			append_dev(label, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	function input0_input_handler_2() {
    		/*input0_input_handler_2*/ ctx[49].call(input0, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}

    	function input_handler_5() {
    		return /*input_handler_5*/ ctx[50](/*path*/ ctx[14]);
    	}

    	function input1_input_handler_2() {
    		/*input1_input_handler_2*/ ctx[51].call(input1, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}

    	function input_handler_6() {
    		return /*input_handler_6*/ ctx[52](/*path*/ ctx[14]);
    	}

    	function select_change_handler_1() {
    		/*select_change_handler_1*/ ctx[53].call(select, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}

    	function change_handler() {
    		return /*change_handler*/ ctx[54](/*path*/ ctx[14]);
    	}

    	function select_block_type_2(ctx, dirty) {
    		if (/*path*/ ctx[14].robotHeading === 'linear') return create_if_block_4;
    		if (/*path*/ ctx[14].robotHeading === 'tangential') return create_if_block_5;
    		if (/*path*/ ctx[14].robotHeading === 'constant') return create_if_block_6;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			option0.textContent = "Tangential";
    			option1 = element("option");
    			option1.textContent = "Linear";
    			option2 = element("option");
    			option2.textContent = "Constant";
    			t9 = space();
    			if (if_block) if_block.c();
    			attr_dev(label0, "class", "cp-x svelte-xlwemc");
    			attr_dev(label0, "for", label0_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80]);
    			set_style(label0, "user-select", "none");
    			add_location(label0, file, 987, 12, 28014);
    			attr_dev(input0, "id", input0_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80]);
    			attr_dev(input0, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 988, 12, 28117);
    			attr_dev(div0, "class", "control-point-mini-box-x svelte-xlwemc");
    			add_location(div0, file, 986, 11, 27963);
    			attr_dev(label1, "class", "cp-y svelte-xlwemc");
    			attr_dev(label1, "for", label1_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80] + "-y");
    			set_style(label1, "user-select", "none");
    			add_location(label1, file, 991, 12, 28402);
    			attr_dev(input1, "id", input1_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80] + "-y");
    			attr_dev(input1, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 992, 12, 28507);
    			attr_dev(div1, "class", "control-point-mini-box-y svelte-xlwemc");
    			add_location(div1, file, 990, 11, 28351);
    			option0.__value = "tangential";
    			option0.value = option0.__value;
    			attr_dev(option0, "class", "svelte-xlwemc");
    			add_location(option0, file, 996, 12, 28956);
    			option1.__value = "linear";
    			option1.value = option1.__value;
    			attr_dev(option1, "class", "svelte-xlwemc");
    			add_location(option1, file, 997, 12, 29015);
    			option2.__value = "constant";
    			option2.value = option2.__value;
    			attr_dev(option2, "class", "svelte-xlwemc");
    			add_location(option2, file, 998, 12, 29066);
    			attr_dev(select, "id", "robot-heading");
    			attr_dev(select, "class", "standard-input-box svelte-xlwemc");
    			if (/*path*/ ctx[14].robotHeading === void 0) add_render_callback(select_change_handler_1);
    			add_location(select, file, 995, 11, 28811);
    			attr_dev(div2, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div2, file, 985, 10, 27915);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].x);
    			append_dev(div2, t2);
    			...
    			set_input_value(input1, /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].y);
    			append_dev(div2, t5);
    			append_dev(div2, select);
    			append_dev(select, option0);
    			append_dev(select, option1);
    			append_dev(select, option2);
    			select_option(select, /*path*/ ctx[14].robotHeading, true);
    			append_dev(div2, t9);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths*/ 32 && label0_for_value !== (label0_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80])) {
    				attr_dev(label0, "for", label0_for_value);
    			}

    			if (dirty[0] & /*$paths*/ 32 && input0_id_value !== (input0_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80])) {
    				attr_dev(input0, "id", input0_id_value);
    			}

    			if (dirty[0] & /*$paths*/ 32 && to_number(input0.value) !== /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].x) {
    				set_input_value(input0, /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].x);
    			}

    			if (dirty[0] & /*$paths*/ 32 && label1_for_value !== (label1_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80] + "-y")) {
    				attr_dev(label1, "for", label1_for_value);
    			}

    			if (dirty[0] & /*$paths*/ 32 && input1_id_value !== (input1_id_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80] + "-y")) {
    				attr_dev(input1, "id", input1_id_value);
    			}

    			if (dirty[0] & /*$paths*/ 32 && to_number(input1.value) !== /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].y) {
    				set_input_value(input1, /*path*/ ctx[14].controlPoints[/*path*/ ctx[14].controlPoints.length - 1].y);
    			}

    			if (dirty[0] & /*$paths*/ 32) {
    				select_option(select, /*path*/ ctx[14].robotHeading);
    			}
    ...
    // (964:10) {#if i > 0 && i!=path.controlPoints.length-1}
    function create_if_block_1(ctx) {
    	...
    	function input0_input_handler_1() {
    		/*input0_input_handler_1*/ ctx[44].call(input0, /*i*/ ctx[80], /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	function input1_input_handler_1() {
    		/*input1_input_handler_1*/ ctx[46].call(input1, /*i*/ ctx[80], /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	let if_block = /*i*/ ctx[80] > 0 && create_if_block_2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label0, "for", label0_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80]);
    			set_style(label0, "user-select", "none");
    			add_location(label0, file, 966, 13, 26533);
    			attr_dev(input0, "id", "cp-input");
    			attr_dev(input0, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 967, 13, 26637);
    			attr_dev(div0, "class", "control-point-mini-box-x svelte-xlwemc");
    			add_location(div0, file, 965, 12, 26481);
    			attr_dev(label1, "class", "cp-y svelte-xlwemc");
    			attr_dev(label1, "for", label1_for_value = "control-point-" + /*path*/ ctx[14].id + "-" + /*i*/ ctx[80] + "-y");
    			set_style(label1, "user-select", "none");
    			add_location(label1, file, 970, 13, 26880);
    			attr_dev(input1, "id", "cp-input");
    			attr_dev(input1, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 971, 13, 26986);
    			attr_dev(div1, "class", "control-point-mini-box-y svelte-xlwemc");
    			add_location(div1, file, 969, 12, 26828);
    			attr_dev(div2, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div2, file, 964, 11, 26432);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
    			...
    			append_dev(div0, t1);
    			append_dev(div0, input0);
    			set_input_value(input0, /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].x);
    			append_dev(div2, t2);
    			append_dev(div2, div1);
    			append_dev(div1, label1);
    			append_dev(label1, t3);
    			append_dev(div1, t4);
    			append_dev(div1, input1);
    			set_input_value(input1, /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].y);
    			append_dev(div2, t5);
    			if (if_block) if_block.m(div2, null);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths*/ 32 && to_number(input0.value) !== /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].x) {
    				set_input_value(input0, /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].x);
    			}
    			...
    			if (dirty[0] & /*$paths*/ 32 && to_number(input1.value) !== /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].y) {
    				set_input_value(input1, /*path*/ ctx[14].controlPoints[/*i*/ ctx[80]].y);
    			}

    			if (/*i*/ ctx[80] > 0) if_block.p(ctx, dirty);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(964:10) {#if i > 0 && i!=path.controlPoints.length-1}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	function input_input_handler_3() {
    		/*input_input_handler_3*/ ctx[61].call(input, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input, "type", "number");
    			attr_dev(input, "step", "0.01");
    			add_location(input, file, 1015, 13, 30070);
    			attr_dev(div, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div, file, 1014, 12, 30020);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, input);
    			set_input_value(input, /*path*/ ctx[14].constantAngle);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", input_input_handler_3),
    					listen_dev(input, "input", /*input_handler_10*/ ctx[62], false, false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths*/ 32 && to_number(input.value) !== /*path*/ ctx[14].constantAngle) {
    				set_input_value(input, /*path*/ ctx[14].constantAngle);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_5(ctx) {
    	...
    	function input_change_handler() {
    		/*input_change_handler*/ ctx[59].call(input, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(label, "user-select", "none");
    			attr_dev(label, "class", "svelte-xlwemc");
    			add_location(label, file, 1010, 13, 29752);
    			attr_dev(input, "id", "reverse");
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "class", "svelte-xlwemc");
    			add_location(input, file, 1011, 13, 29829);
    			attr_dev(div, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div, file, 1009, 12, 29702);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			append_dev(div, t1);
    			append_dev(div, input);
    			input.checked = /*path*/ ctx[14].reverse;

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "change", input_change_handler),
    					listen_dev(input, "input", /*input_handler_9*/ ctx[60], false, false, false, false)
    				];
    ...
    // (1002:11) {#if path.robotHeading === 'linear'}
    function create_if_block_4(ctx) {
    	...
    	function input0_input_handler_3() {
    		/*input0_input_handler_3*/ ctx[55].call(input0, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}

    	function input1_input_handler_3() {
    		/*input1_input_handler_3*/ ctx[57].call(input1, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 1003, 13, 29242);
    			attr_dev(div0, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div0, file, 1002, 12, 29192);
    			attr_dev(input1, "id", "end-angle");
    			attr_dev(input1, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 1006, 13, 29471);
    			attr_dev(div1, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div1, file, 1005, 12, 29421);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			append_dev(div0, input0);
    			set_input_value(input0, /*path*/ ctx[14].startAngle);
    			insert_dev(target, t, anchor);
    			insert_dev(target, div1, anchor);
    			append_dev(div1, input1);
    			set_input_value(input1, /*path*/ ctx[14].endAngle);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", input0_input_handler_3),
    					listen_dev(input0, "input", /*input_handler_7*/ ctx[56], false, false, false, false),
    					listen_dev(input1, "input", input1_input_handler_3),
    					listen_dev(input1, "input", /*input_handler_8*/ ctx[58], false, false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths*/ 32 && to_number(input0.value) !== /*path*/ ctx[14].startAngle) {
    				set_input_value(input0, /*path*/ ctx[14].startAngle);
    			}

    			if (dirty[0] & /*$paths*/ 32 && to_number(input1.value) !== /*path*/ ctx[14].endAngle) {
    				set_input_value(input1, /*path*/ ctx[14].endAngle);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1002:11) {#if path.robotHeading === 'linear'}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	function click_handler_4() {
    		return /*click_handler_4*/ ctx[48](/*path*/ ctx[14], /*i*/ ctx[80]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-xlwemc");
    			add_location(path_1, file, 979, 285, 27616);
    			...
    			attr_dev(svg, "class", "svelte-xlwemc");
    			add_location(svg, file, 979, 11, 27342);
    		},
    		m: function mount(target, anchor) {
    ...
    // (957:8) {#each path.controlPoints as { x, y }
    function create_each_block_1(ctx) {
    	let div;
    	let t;

    	function select_block_type(ctx, dirty) {
    		if (/*i*/ ctx[80] == 0) return create_if_block_7;
    		if (/*i*/ ctx[80] > 0 && /*i*/ ctx[80] != /*path*/ ctx[14].controlPoints.length - 1) return create_if_block_8;
    	}
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*i*/ ctx[80] > 0 && /*i*/ ctx[80] != /*path*/ ctx[14].controlPoints.length - 1) return create_if_block_1;
    		if (/*i*/ ctx[80] == 0) return create_if_block_3;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "control-point-box svelte-xlwemc");
    			add_location(div, file, 957, 9, 26028);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(957:8) {#each path.controlPoints as { x, y }",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	function input_input_handler_2() {
    		/*input_input_handler_2*/ ctx[39].call(input, /*each_value*/ ctx[77], /*path_index*/ ctx[78]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "svelte-xlwemc");
    			add_location(path0, file, 939, 534, 23416);
    			...
    			attr_dev(svg0, "class", "svelte-xlwemc");
    			add_location(svg0, file, 939, 8, 22890);
    			attr_dev(path1, "d", "M440-240v-368L296-464l-56-56 240-240 240 240-56 56-144-144v368h-80Z");
    			attr_dev(path1, "class", "svelte-xlwemc");
    			add_location(path1, file, 942, 482, 24114);
    			...
    			attr_dev(svg1, "class", "svelte-xlwemc");
    			add_location(svg1, file, 942, 8, 23640);
    			attr_dev(input, "type", "color");
    			attr_dev(input, "class", "color-circle svelte-xlwemc");
    			set_style(input, "background-color", /*path*/ ctx[14].color);
    			add_location(input, file, 943, 8, 24208);
    			attr_dev(p, "class", "path-title svelte-xlwemc");
    			set_style(p, "user-select", "none");
    			add_location(p, file, 944, 8, 24378);
    			attr_dev(div0, "class", "path-and-color svelte-xlwemc");
    			add_location(div0, file, 936, 7, 22721);
    			...
    			attr_dev(path2, "class", "svelte-xlwemc");
    			add_location(path2, file, 950, 276, 24972);
    			...
    			attr_dev(svg2, "class", "svelte-xlwemc");
    			add_location(svg2, file, 950, 8, 24704);
    			...
    			attr_dev(path3, "class", "svelte-xlwemc");
    			add_location(path3, file, 951, 347, 25532);
    			...
    			attr_dev(svg3, "class", "svelte-xlwemc");
    			add_location(svg3, file, 951, 8, 25193);
    			attr_dev(div1, "class", "add-and-remove svelte-xlwemc");
    			add_location(div1, file, 948, 7, 24602);
    			attr_dev(div2, "class", "path-header svelte-xlwemc");
    			add_location(div2, file, 935, 6, 22688);
    			attr_dev(div3, "class", "path-control-points svelte-xlwemc");
    			add_location(div3, file, 955, 7, 25935);
    			attr_dev(div4, "class", "path svelte-xlwemc");
    			set_style(div4, "border-color", /*path*/ ctx[14].color);
    			add_location(div4, file, 934, 5, 22627);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths, generateBezierCurve, paths, updateRobotPosition*/ 16875552) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(934:4) {#each $paths as path}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-xlwemc");
    			add_location(path_1, file, 1040, 134, 31172);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "height", "24px");
    			attr_dev(svg, "viewBox", "0 -960 960 960");
    			attr_dev(svg, "width", "24px");
    			attr_dev(svg, "fill", "#FF474D");
    			attr_dev(svg, "class", "svelte-xlwemc");
    			add_location(svg, file, 1040, 6, 31044);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path_1);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "class", "svelte-xlwemc");
    			add_location(path_1, file, 1038, 134, 30941);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "height", "24px");
    			attr_dev(svg, "viewBox", "0 -960 960 960");
    			attr_dev(svg, "width", "24px");
    			...
    			attr_dev(svg, "class", "svelte-xlwemc");
    			add_location(svg, file, 1038, 7, 30814);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path_1);
    			...
    			if (!mounted) {
    				dispose = listen_dev(svg, "click", /*playPath*/ ctx[23], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*$paths*/ ctx[5].length > 0 && create_if_block_11(ctx);
    	let if_block1 = /*$paths*/ ctx[5].length > 0 && create_if_block_10(ctx);
    	...
    	let if_block2 = /*$paths*/ ctx[5].length > 0 && create_if_block_9(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "page-title svelte-xlwemc");
    			add_location(h1, file, 833, 2, 18729);
    			set_style(button0, "user-select", "none");
    			attr_dev(button0, "class", "svelte-xlwemc");
    			add_location(button0, file, 835, 3, 18798);
    			set_style(button1, "user-select", "none");
    			attr_dev(button1, "class", "svelte-xlwemc");
    			add_location(button1, file, 836, 3, 18897);
    			attr_dev(div0, "class", "export-import svelte-xlwemc");
    			add_location(div0, file, 834, 2, 18767);
    			attr_dev(div1, "class", "header svelte-xlwemc");
    			add_location(div1, file, 832, 1, 18706);
    			attr_dev(h20, "class", "section-title svelte-xlwemc");
    			set_style(h20, "user-select", "none");
    			add_location(h20, file, 846, 6, 19154);
    			attr_dev(label0, "for", "robotUnits");
    			set_style(label0, "user-select", "none");
    			attr_dev(label0, "class", "svelte-xlwemc");
    			add_location(label0, file, 849, 7, 19267);
    			option0.__value = "inches";
    			option0.value = option0.__value;
    			attr_dev(option0, "class", "svelte-xlwemc");
    			add_location(option0, file, 851, 8, 19423);
    			option1.__value = "cm";
    			option1.value = option1.__value;
    			attr_dev(option1, "class", "svelte-xlwemc");
    			add_location(option1, file, 852, 8, 19470);
    			attr_dev(select, "id", "robotUnits");
    			attr_dev(select, "class", "standard-input-box svelte-xlwemc");
    			if (/*robotUnits*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[28].call(select));
    			add_location(select, file, 850, 7, 19339);
    			attr_dev(div2, "class", "robot-options svelte-xlwemc");
    			add_location(div2, file, 848, 6, 19232);
    			attr_dev(label1, "for", "robot-length");
    			set_style(label1, "user-select", "none");
    			attr_dev(label1, "class", "svelte-xlwemc");
    			add_location(label1, file, 857, 7, 19582);
    			attr_dev(input0, "id", "robot-length");
    			attr_dev(input0, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file, 858, 7, 19663);
    			attr_dev(div3, "class", "robot-options svelte-xlwemc");
    			add_location(div3, file, 856, 6, 19547);
    			attr_dev(label2, "for", "robot-width");
    			set_style(label2, "user-select", "none");
    			attr_dev(label2, "class", "svelte-xlwemc");
    			add_location(label2, file, 862, 7, 19826);
    			attr_dev(input1, "id", "robot-width");
    			attr_dev(input1, "class", "standard-input-box svelte-xlwemc");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file, 863, 7, 19905);
    			attr_dev(div4, "class", "robot-options svelte-xlwemc");
    			add_location(div4, file, 861, 6, 19791);
    			attr_dev(h21, "id", "field-options");
    			attr_dev(h21, "class", "section-title svelte-xlwemc");
    			set_style(h21, "user-select", "none");
    			add_location(h21, file, 868, 6, 20039);
    			set_style(label3, "user-select", "none");
    			attr_dev(label3, "class", "svelte-xlwemc");
    			add_location(label3, file, 871, 6, 20199);
    			attr_dev(label4, "class", "cp-x svelte-xlwemc");
    			set_style(label4, "user-select", "none");
    			add_location(label4, file, 877, 8, 20429);
    			attr_dev(div5, "class", "control-point-mini-box-x svelte-xlwemc");
    			add_location(div5, file, 875, 7, 20317);
    			attr_dev(label5, "class", "cp-x svelte-xlwemc");
    			set_style(label5, "user-select", "none");
    			add_location(label5, file, 884, 8, 20811);
    			attr_dev(div6, "class", "control-point-mini-box-y svelte-xlwemc");
    			add_location(div6, file, 882, 7, 20699);
    			attr_dev(div7, "class", "control-point-mini-box svelte-xlwemc");
    			add_location(div7, file, 874, 6, 20273);
    			attr_dev(h22, "id", "advanced-options");
    			attr_dev(h22, "class", "section-title svelte-xlwemc");
    			set_style(h22, "user-select", "none");
    			add_location(h22, file, 891, 6, 21095);
    			attr_dev(label6, "for", "field-length");
    			set_style(label6, "user-select", "none");
    			attr_dev(label6, "class", "svelte-xlwemc");
    			add_location(label6, file, 893, 7, 21235);
    			attr_dev(input2, "id", "auto-link-paths");
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "class", "svelte-xlwemc");
    			add_location(input2, file, 894, 7, 21326);
    			attr_dev(div8, "class", "advanced-options svelte-xlwemc");
    			add_location(div8, file, 892, 6, 21197);
    			attr_dev(label7, "for", "field-length");
    			set_style(label7, "user-select", "none");
    			attr_dev(label7, "class", "svelte-xlwemc");
    			add_location(label7, file, 897, 7, 21462);
    			attr_dev(input3, "id", "auto-link-paths");
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "class", "svelte-xlwemc");
    			add_location(input3, file, 898, 7, 21546);
    			attr_dev(div9, "class", "advanced-options svelte-xlwemc");
    			add_location(div9, file, 896, 6, 21424);
    			attr_dev(div10, "class", "svelte-xlwemc");
    			add_location(div10, file, 845, 5, 19142);
    			attr_dev(div11, "class", "robot-options-menu svelte-xlwemc");
    			add_location(div11, file, 844, 4, 19104);
    			attr_dev(div12, "class", "settings-column svelte-xlwemc");
    			add_location(div12, file, 843, 3, 19070);
    			...
    			attr_dev(svg, "class", "svelte-xlwemc");
    			add_location(svg, file, 919, 5, 22216);
    			attr_dev(div13, "class", "field svelte-xlwemc");
    			add_location(div13, file, 904, 3, 21672);
    			set_style(button2, "user-select", "none");
    			attr_dev(button2, "class", "svelte-xlwemc");
    			add_location(button2, file, 1027, 4, 30367);
    			attr_dev(div14, "class", "paths svelte-xlwemc");
    			add_location(div14, file, 932, 3, 22575);
    			attr_dev(div15, "class", "container svelte-xlwemc");
    			add_location(div15, file, 842, 2, 19043);
    			attr_dev(div16, "class", "play-button svelte-xlwemc");
    			add_location(div16, file, 1033, 4, 30567);
    			attr_dev(input4, "type", "range");
    			attr_dev(input4, "id", "scrub");
    			attr_dev(input4, "min", "0");
    			attr_dev(input4, "max", "100");
    			attr_dev(input4, "step", "0.001");
    			attr_dev(input4, "class", "svelte-xlwemc");
    			add_location(input4, file, 1044, 4, 31352);
    			attr_dev(div17, "class", "scrubbing-bar svelte-xlwemc");
    			add_location(div17, file, 1032, 3, 30535);
    			attr_dev(div18, "class", "footer svelte-xlwemc");
    			add_location(div18, file, 1031, 2, 30511);
    			attr_dev(div19, "class", "main-content svelte-xlwemc");
    			add_location(div19, file, 840, 1, 19012);
    			attr_dev(div20, "class", "svelte-xlwemc");
    			add_location(div20, file, 831, 0, 18699);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*click_handler_5*/ ctx[63], false, false, false, false),
    					listen_dev(input4, "change", /*input4_change_input_handler*/ ctx[64]),
    					listen_dev(input4, "input", /*input4_change_input_handler*/ ctx[64]),
    					listen_dev(input4, "input", /*updateRobotPosition*/ ctx[24], false, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$paths, generateBezierCurve, paths, updateRobotPosition, addControlPointToPathWithIndex, deletePath, updatePathColor, checkAutoLinkControlPoints*/ 91324448) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function input0_input_handler_2(each_value, path_index) {
    		each_value[path_index].controlPoints[path.controlPoints.length - 1].x = to_number(this.value);
    		paths.set($paths);
    	}

    	const input_handler_5 = path => generateBezierCurve(path.id);

    	function input1_input_handler_2(each_value, path_index) {
    		each_value[path_index].controlPoints[path.controlPoints.length - 1].y = to_number(this.value);
    		paths.set($paths);
    	}

    	const input_handler_6 = path => generateBezierCurve(path.id);

    	function select_change_handler_1(each_value, path_index) {
    	...
    	function input0_input_handler_3(each_value, path_index) {
    		each_value[path_index].startAngle = to_number(this.value);
    		paths.set($paths);
    	}

    	const input_handler_7 = () => updateRobotPosition();

    	function input1_input_handler_3(each_value, path_index) {
    		each_value[path_index].endAngle = to_number(this.value);
    		paths.set($paths);
    	}

    	const input_handler_8 = () => updateRobotPosition();
    	...
    	function input_input_handler_3(each_value, path_index) {
    		each_value[path_index].constantAngle = to_number(this.value);
    		paths.set($paths);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('animInterval' in $$props) $$invalidate(75, animInterval = $$props.animInterval);
    		...
    		if ('motionBlurAmount' in $$props) $$invalidate(76, motionBlurAmount = $$props.motionBlurAmount);
